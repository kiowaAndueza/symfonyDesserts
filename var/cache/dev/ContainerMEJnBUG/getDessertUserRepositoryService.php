 ...
 */
class getDessertUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DessertUserRepository' shared autowired service.
     *
     * @return \App\Repository\DessertUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DessertUserRepository.php';

        return $container->privates['App\\Repository\\DessertUserRepository'] = new \App\Repository\DessertUserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
