 ...
 */
class getDessertRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DessertRepository' shared autowired service.
     *
     * @return \App\Repository\DessertRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DessertRepository.php';

        return $container->privates['App\\Repository\\DessertRepository'] = new \App\Repository\DessertRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
