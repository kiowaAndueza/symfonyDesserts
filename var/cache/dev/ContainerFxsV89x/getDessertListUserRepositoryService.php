 ...
 */
class getDessertListUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DessertListUserRepository' shared autowired service.
     *
     * @return \App\Repository\DessertListUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DessertListUserRepository.php';

        return $container->privates['App\\Repository\\DessertListUserRepository'] = new \App\Repository\DessertListUserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
